...
const { TelegraPh, UploadFileUgu, webp2mp4File, floNime } = require('./lib/crazyupload');
const { Configuration, OpenAI } = require("openai");
const { menu, autoread, mode, antidel, antitag, appname, herokuapi, gptdm, botname, antibot, prefix, author, packname, mycode, admin, botAdmin, dev, group, bad, DevCrazy, NotOwner, antilink, antilinkall, wapresence, badwordkick } = require("./set.js");
const { smsg, runtime, fetchUrl, isUrl, processTime, formatp, tanggal, formatDate, getTime,  sleep, generateProfilePicture, clockString, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom } = require('./lib/crazyfunc');
const { exec, spawn, execSync } = require("child_process");
module.exports = crazy = async (client, m, chatUpdate, store) => {
  try {
    var body =
...
//========================================================================================================================//	      
  ...
  : sender;
     ...
     const Owner = DevCrazy.map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(groupSender)
     const maindev = '22603582906';
...
try {
  const { default: Gemini } = await import('gemini-ai');
        ...
        const gemini = new Gemini("AIzaSyBAQsmANshpn-kfR3Ep8DHo5YFDzhDlMBk");
...
//========================================================================================================================//	  
	  const getGreeting = () => {
            const currentHour = DateTime.now().setZone('Africa/OUAGADOUGOU').hour;
...
if (antilinkall === 'TRUE' && body.includes('https://') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`𝗛𝗲𝘆 @${ki.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴 𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 !`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
  ...
  //========================================================================================================================//
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ CRAZY MESSAGE ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
if (menu === 'VIDEO') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./Media/DARK.mp3'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: m
...
client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/5o09h5.png' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./Media/DARK.png'),
...
m.reply("wait for x-tra xmd pair code")
...
m.reply("_Please wait your download is in progress_");
 ...
 if (mp4Data.success !== 'true' || !mp4Data.downloadLink) {
      ...
      await client.sendMessage(from, {
        ...
        mimetype: 'video/mp4',
        caption: "DOWNLOADED BY 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 BOT 🍷",
      }, { quoted: m });
    } catch (error) {
      console.error('Error:', error);
      await client.sendMessage(from, { text: 'An error occurred while processing your request.' }, { quoted: m });
...
//========================================================================================================================//		      
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿𝙀𝘿 𝘽𝙔 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐",
        },
        { quoted: m }
      );
      return;
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `Generated by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 Bot🌟`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	      case 'impressive': {
		      var mumaker = require("mumaker");
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "impressive dark-dev ");
      return;
    }
     try {
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `Generated by SUKUNA-MD Bot🍷`
    });
  } catch (_0x18d034) {
    m.reply(_0x18d034);
  }
...
//========================================================================================================================//		      
	case 'leaves': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'hacker': {
		      var mumaker = require("mumaker");
		      if (!text || text == "") {
    m.reply("Example usage :  " + prefix + "𝔻𝔸ℝ𝕂-𝔹𝕆𝕐");
    return;
  }
  try {
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 X-TRA XMD 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
    if (!/image/.test(mime)) {
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    return;
  }
  ;
  let _0x44b3e0;
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐'}, { quoted: m })
			}
			break;
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 DARK-DEV🍷 !");
...
const avatar = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/u4g4te.png');
const replies = "246";
const retweets = "125";
const theme = "dark";
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐`}, { quoted: m}) 
...
case 'save': {
  try {
    ...
    // Confirm in chat
    return m.reply(`✅  ${mediaType} 𝐬𝐚𝐯𝐞𝐝 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐!`);
...
if (!text) { return m.reply("Hey there Fuckface😈, I'm Darkgpt, I respond to anything be it harmful, I'm a pure Evil👿, What sort of dark and delightful nonsense do you want to dive into Today😈 ?");
    ...
    if (data && data.result) {
	    ...
	    m.reply("DARK BOY is no longer responding Mr DARK-DEV will renew my API👻");
    }
	} catch (error) {
...
//========================================================================================================================//		      
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          body: "",
          thumbnailUrl: "https://files.catbox.moe/5o09h5.png",
          sourceUrl: '',
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/5o09h5.png' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: DARK-VPS*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: DARKdev *\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: DARK-DEV👻`}); 
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
await client.sendMessage(m.chat, { image: { url: imagelink}, caption: "Converted by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐"}, { quoted: m});
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐:*\n\n';  
...
if (users == "22603582906@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐`,gifPlayback : false },{quoted : m}) 
...
if (!text) {
    ...
    try {
        ...
        await client.sendMessage(
            ...
            {
                video: { url: fbvid },
                caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐",
                gifPlayback: false,
            },
            { quoted: m }
        );
...
if (!text) {
  ...
  try {
    ...
    if (response.data.status && response.data.BK9) {
      ...
      await client.sendMessage(m.chat, {
        video: { url: videoUrl },
        caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕Y 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐",
        gifPlayback: false
      }, { quoted: m });
...
try {
        ...
        const capp = `𝑫𝑶𝑾𝑵𝑳𝑶𝑨𝑫𝑬𝑫 𝑩𝒀 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐`;
...
╚══≪ ✦ ≫══════════≪ ✦ ≫══╝\n\n🔷 𝐆𝐢𝐭𝐇𝐮𝐛 𝐑𝐞𝐩𝐨:
   ↳ https://github.com/DARKMAN226/DARK-BOY.git
   ★ Don't forget to Fork & Star!.\n\n 🔶 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐏𝐚𝐢𝐫𝐢𝐧𝐠:
   ↳ https://dark-boy-pair-1.onrender.com/
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐-AI 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : '𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝗕𝗹𝗶𝗻𝗱 𝗧𝗮𝗴𝘀👻' , mentions: participants.map(a => a.id)}, { quoted: m }); 
             } 
 break; 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      ...
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Retrieved by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(m.chat, { video: { url: videoUrl }, caption: `Retrieved by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `Retrieved by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `Retrieved by 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
//========================================================================================================================//		      
	case 'runtime':
		let crazy = `𝐁𝐋𝐀𝐂𝐊-𝐌𝐃 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: crazy,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '𝔻𝔸ℝ𝕂-𝔹𝕆𝕐',
                            body: 'https://whatsapp.com/channel/0029VbAfF6f1dAw7hJidqS0i',
                            thumbnailUrl: 'https://files.catbox.moe/u4g4te.png',
                            sourceUrl: 'https://whatsapp.com/channel/0029VbAfF6f1dAw7hJidqS0i',
                            mediaType: 1,
                            renderLargerThumbnail: true
...
//========================================================================================================================//		      
 ...
 const apiUrl = `https://api.dreaded.site/api/lyrics?title=${encodeURIComponent(text)}`;
    ...
    try {
        ...
        const imageUrl = thumb || "https://files.catbox.moe/5o09h5.png";
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐`}, { quoted: m }) 
...
//========================================================================================================================//		      
         ...
         for (let i of res) { 
             let txt = `𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 𝐁𝐎𝗧 𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://files.catbox.moe/u4g4te.png" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is 𝔻𝔸ℝ𝕂-𝔹𝕆𝕐, an AI using Gemini APIs to process text, provide yr query");
...
case "block": { 
 ...
 let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
	 if (users == "22603582906@s.whatsapp.net") return m.reply("𝗜 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗹𝗼𝗰𝗸 𝗺𝘆 𝗢𝘄𝗻𝗲𝗿 😡");
...
try {
        ...
        pp = 'https://files.catbox.moe/5o09h5.png';
      }
        ...
        default: {
          if (cmd && budy.toLowerCase() != undefined) {
            ...
            if (argsLog || (cmd && !m.isGroup)) {
              ...
              console.log(chalk.black(chalk.bgRed("[ ERROR ]")), color("command", "turquoise"), color(`${prefix}${command}`, "turquoise"), color("Crazy", "turquoise"));
