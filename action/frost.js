...
module.exports = frost = async (client, m, chatUpdate, store) => {
  try {
    var body =
...
//========================================================================================================================//
//========================================================================================================================//	  
    const frosti = (m.quoted || m); 
    const quoted = (frostii.mtype == 'buttonsMessage') ? frosti[Object.keys(frosti)[1]] : (frosti.mtype == 'templateMessage') ? frosti.hydratedTemplate[Object.keys(frosti.hydratedTemplate)[1]] : (frosti.mtype == 'product') ? frosti[Object.keys(frosti)[0]] : m.quoted ? m.quoted : m; 
...
//========================================================================================================================//		      
  ...
  try {
    let frost = await mumaker.ephoto("https://en.ephoto360.com/handwritten-text-on-foggy-glass-online-680.html", text);
    m.reply("*🌐 Wait a moment...*");
    await client.sendMessage(m.chat, {
      image: {
        url: frost.image
...
case "kill": case "kickall": {
	  if (!m.isGroup) throw group;
          ...
          let frosti = participants.filter(_0x5202af => _0x5202af.id != client.decodeJid(client.user.id)).map(_0x3c0c18 => _0x3c0c18.id);
      ...
      await client.groupRevokeInvite(m.chat);
          ...
          setTimeout(() => {
            client.sendMessage(m.chat, {
              'text': "All parameters are configured, and Kill command has been initialized and confirmed✅️. Now, all " + frosti.length + " group participants will be removed in the next second.\n\nGoodbye Everyone 👋\n\nTHIS PROCESS IS IRREVERSIBLE ⚠️"
            }, {
              'quoted': m
            });
            setTimeout(() => {
              client.groupParticipantsUpdate(m.chat, frosti, "remove");
              setTimeout(() => {
